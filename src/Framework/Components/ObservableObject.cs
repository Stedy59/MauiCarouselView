...
namespace StedySoft.Maui.Framework {
	...
	public class ObservableObject : INotifyPropertyChanged {
		...
		#region Methods
		protected bool SetProperty<T>([NotNullIfNotNull(nameof(newValue))] ref T property,
				T newValue, [CallerMemberName] string? propertyName = null, Action? onChanged = null) {
		...
		protected void OnPropertyChanged([CallerMemberName] string? propertyName = null) =>
			this.weakEventManager.HandleEvent(
				this,

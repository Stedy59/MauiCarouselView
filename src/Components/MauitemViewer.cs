...
#if MONOANDROID
using PositionChangedEventArgs = Microsoft.Maui.Controls.PositionChangedEventArgs;
#elif WINDOWS
using PositionChangedEventArgs = StedySoft.Maui.Framework.Controls.PositionChangedEventArgs;
#endif
...
namespace StedySoft.CarouselView.Components {
	...
	public class MauiItemViewer : ContentView, IDisposable {
		...
		#region Constructor
		public MauiItemViewer() =>
			this.ControlTemplate =
				Application.Current.Resources.TryGetTemplate("MauiItemViewerTemplate");
		...
		public static readonly BindableProperty ViewerItemsProperty =
			BindableProperty.Create(
				nameof(MauiItemViewer.ViewerItems),
				typeof(ObservableCollection<ItemViewerItem>),
				typeof(MauiItemViewer),
		...
		public static readonly BindableProperty SelectedIndexProperty =
			BindableProperty.Create(
				nameof(MauiItemViewer.SelectedIndex),
				typeof(int),
				typeof(MauiItemViewer),
				-1,
				BindingMode.TwoWay,
				propertyChanged: async (b, o, n) => {
					if ((int)n >= 0 && (int)n != (int)o) {
						await b.As<MauiItemViewer>()?._updateSelectedIndexAsync((int)n);
					}
				});
		...
		public static readonly BindableProperty ItemContainerHeightProperty =
			BindableProperty.Create(
				nameof(MauiItemViewer.ItemContainerHeight),
				typeof(double),
				typeof(MauiItemViewer),
				30d);
		...
		public static readonly BindableProperty IndicatorColorProperty =
			BindableProperty.Create(
				nameof(MauiItemViewer.IndicatorColor),
				typeof(Color),
				typeof(MauiItemViewer),
		...
		public static readonly BindableProperty IndicatorHeightProperty =
			BindableProperty.Create(
				nameof(MauiItemViewer.IndicatorHeight),
				typeof(double),
				typeof(MauiItemViewer),
				2d);
		...
		public static readonly BindableProperty IndicatorWidthProperty =
			BindableProperty.Create(
				nameof(MauiItemViewer.IndicatorWidth),
				typeof(double),
				typeof(MauiItemViewer),
				default(double));
		...
		public static readonly BindableProperty IndicatorTranslationXProperty =
			BindableProperty.Create(
				nameof(MauiItemViewer.IndicatorTranslationX),
				typeof(double),
				typeof(MauiItemViewer),
				2d);
		...
		public static readonly BindableProperty ItemContentHeightProperty =
			BindableProperty.Create(
				nameof(MauiItemViewer.ItemContentHeight),
				typeof(double),
				typeof(MauiItemViewer),
				0d);
		...
		public static readonly BindableProperty ItemContentWidthProperty =
			BindableProperty.Create(
				nameof(MauiItemViewer.ItemContentWidth),
				typeof(double),
				typeof(MauiItemViewer),
				0d);
		...
		protected override void OnApplyTemplate() {
			...
			this._contentContainer ??= this._mainContainer?.FindByName<MauiCarouselView>("contentContainer");
			this.ViewerItems.CollectionChanged += this.OnViewerItemsCollectionChanged;
			this._contentContainer.PositionChanged += this.OnContentContainerPositionChanged;
			this._contentContainer.Scrolled += this.OnContentContainerScrolled;
			this._contentContainer.ScrollToRequested += this.OnContentContainerScrollToRequested;
